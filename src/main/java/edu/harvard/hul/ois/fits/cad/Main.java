...
public class Main {
    ...
    public static void pdfbox_validate(DataSource ds) throws IOException {
    ...
    public void runPdf(DataSource ds) throws IOException {
...
//        pdfbox_validate(ds);
    ...
    public static void main(String[] args) {
        ...
        final DataSource in = new FileDataSource(args[0]);
